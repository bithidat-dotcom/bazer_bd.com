      ...
      <header className="fixed top-0 w-full z-50 bg-[#fff8f6]/80 backdrop-blur-lg border-b border-white/10 shadow-sm flex justify-between items-center px-2 md:px-4 h-16 gap-2">
        ...
        <div className="flex items-center shrink-0">
          <button onClick={() => navigate('/?cart=true')} className="active:scale-95 transition-transform text-[#9d4300] relative p-1">
            <div className="w-8 h-8 rounded-full border border-orange-200/50 hover:bg-orange-50 shadow-sm bg-white flex items-center justify-center transition-colors">
              <ShoppingCart className="w-4 h-4 text-orange-600" />
            </div>
            {cartItemCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-red-600 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center font-bold z-10 shadow-sm leading-none">{cartItemCount}</span>
            )}
          </button>
        </div>
      </header>
          ...
          <div className="bg-white/40 backdrop-blur-md rounded-[2.5rem] p-6 border border-white/50 shadow-xl shadow-pink-500/5">
            ...
            {regularDeals.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                <div className="w-20 h-20 bg-pink-500/5 rounded-full flex items-center justify-center mb-4 text-orange-950/20">

...
export default function WhatsappSupport() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="hidden md:flex fixed bottom-6 right-6 z-50 items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-2xl shadow-[#25D366]/40 hover:bg-[#128C7E] transition-colors group cursor-pointer"

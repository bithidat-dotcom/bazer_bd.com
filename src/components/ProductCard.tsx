  ...
  return (
    ...
    >
        <div className="relative w-full aspect-square rounded-xl bg-slate-50 overflow-hidden mb-3">
          ...
          />
          {hasDiscount && (
            <div className="flex flex-col gap-1 absolute top-2 left-2 sm:top-2.5 sm:left-2.5 z-10">
              <div className="bg-red-600 backdrop-blur-md text-white text-[7px] sm:text-[9px] font-black px-1.5 py-0.5 sm:px-2 sm:py-1.5 rounded shadow-lg uppercase tracking-tight">
                -{product.discount}% OFF
              </div>
              <div className="bg-white/90 backdrop-blur-md border border-slate-150 text-black text-[6px] sm:text-[8px] font-black px-1 py-0.5 sm:px-1.5 sm:py-1 rounded flex items-center gap-1 shadow-md">
